...
(function (EasySlackBot) {
    var Main = (function () {
        function Main(botItems, botOptions, callBack) {
            ...
            this.start(botItems, botOptions, !callBack ? function () {
                // Fake callback
            } : callBack);
        }
        Main.prototype.start = function (botItems, options, callBack) {
            var _this = this;
